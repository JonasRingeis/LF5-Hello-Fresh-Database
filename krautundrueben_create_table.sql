...
CREATE TABLE HALTUNGSFORM (
    HALTUNGSFORM_ID     INTEGER AUTO_INCREMENT NOT NULL,
    FORM                INTEGER,
...
CREATE TABLE ZUTAT(
    ...
    HALTUNGSFORM_ID     INTEGER NOT NULL,
...
CREATE TABLE ERNÄHRUNGSTRENDS (
	ERNÄHRUNGSTREND_ID		INTEGER AUTO_INCREMENT NOT NULL, 
    NAME			        VARCHAR(50),
    BESCHREIBUNG	        VARCHAR(250),
...
CREATE TABLE EXTRAS (
    EXTRA_ID            INTEGER AUTO_INCREMENT NOT NULL,
    NAME                VARCHAR(100),
